...
exports.separateMatches = void 0;
const readLines_1 = require("./readLines");
const separateMatches = () => __awaiter(void 0, void 0, void 0, function* () {
    const fileLines = yield (0, readLines_1.readLines)();
...
exports.separateMatches = separateMatches;
